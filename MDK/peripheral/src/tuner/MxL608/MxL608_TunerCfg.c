...
#include "tuner/MxL608/MxL608_TunerCfg.h"
#include "tuner/MxL608/MxL608_Debug.h"
...
MXL608_STATUS MxL608_Ctrl_SetRfFreqLutTblReg(UINT8_608 devId, UINT32_608 FreqInHz, PMXL608_CHAN_DEPENDENT_FREQ_TABLE_T freqLutPtr)
{
