...
/*------------------------------------------------------------------------------
--| FUNCTION NAME : MxL603_Ctrl_SetRfFreqLutTblReg
--|
--| AUTHOR        : Dong Liu
--|
...
MXL_STATUS MxL603_Ctrl_SetRfFreqLutTblReg(UINT8 devId, UINT32 FreqInHz, PMXL603_CHAN_DEPENDENT_FREQ_TABLE_T freqLutPtr)
{
