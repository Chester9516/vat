...
#include "demod/AVL68XX/AVL_Demod_Patch_DVBTxFw.h"
#endif

#if defined(_AVL68XX_)
#include "demod/AVL68XX/AVL_Demod_Patch_DVBCFw.h"
#endif

#if defined(_AVL68XX_)
#include "demod/AVL68XX/AVL_Demod_Patch_DVBSxFw.h"
#endif

#if defined(_AVL68XX_)
#include "demod/AVL68XX/AVL_Demod_Patch_ISDBTFw.h"
#endif

#if defined(_AVL63XX_)
#include "demod/AVL68XX/AVL_Demod_DTMBFw.h"
#endif
    ...
    if(gstChipInternalArray[uiChipNo].ucCustomizeFwData == 0)
    {
        ...
        case AVL68XX:
            ...
            case AVL_DVBTX:
				...
				pInitialData = AVL_Demod_Patch_DVBTxFw;		//vatek modify
                break;
            case AVL_DVBSX:
                pInitialData = AVL_Demod_Patch_DVBSxFw;
                break;
            case AVL_ISDBT:
                pInitialData = (AVL_puchar) AVL_Demod_Patch_ISDBTFw;
                break;
            case AVL_DVBC:
                pInitialData = (AVL_puchar) AVL_Demod_Patch_DVBCFw;
                break;
            default:
                //pInitialData = AVL_Demod_Patch_DVBTxFw;
				pInitialData = AVL_Demod_Patch_DVBTxFw;		//vatek modify
...
AVL_ErrorCode SetInternalFunc_Demod(AVL_DemodMode eDemodMode, AVL_uint32 uiChipNo)
{
    ...
    if(uiChipNo == 0 || uiChipNo == 1)    
    {
        switch(eDemodMode)
        {
#if (VATEK_DEMOD_CHOOSE == DEMOD_DVBC)
#if defined(_AVL68XX_)
        case AVL_DVBC:
...
#if (VATEK_DEMOD_CHOOSE == DEMOD_DVBS)		
#if defined(_AVL68XX_)
        case AVL_DVBSX:
...
#if (VATEK_DEMOD_CHOOSE == DEMOD_DVBT)		
#if defined(_AVL68XX_)
        case AVL_DVBTX:
...
#if (VATEK_DEMOD_CHOOSE == DEMOD_ISDBT)
#if defined(_AVL68XX_)
        case AVL_ISDBT:
