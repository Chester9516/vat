...
static modulator_type a3_mod_type = m_type_atsc;//m_type_dvb_t, m_type_atsc, m_type_isdb_t, A3 modulator output setting
...
static vatek_result a3_process(){
	...
	a3_input.pcr_mode = pcr_adjust;//pcr_adjust
	a3_input.serial = 1;
