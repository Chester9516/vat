...
qisprops_modconfig* qisprops_modconfig::createDVBTMain(Pdvb_t_config pdvbt)
{
	...
	newmod->insertProperty("scl_0", &pdvbt->scl_0);
	newmod->insertProperty("scl_1", &pdvbt->scl_1);
	newmod->insertProperty("scl_2", &pdvbt->scl_2);
	newmod->insertProperty("fft_scale[2k]", &pdvbt->fft_scale[fft_2k]);
	newmod->insertProperty("fft_scale[8k]", &pdvbt->fft_scale[fft_8k]);
	newmod->insertProperty("fft_scale[4k]", &pdvbt->fft_scale[fft_4k]);
	newmod->insertProperty("gain[2k]", &pdvbt->gain[fft_2k]);
	newmod->insertProperty("gain[8k]", &pdvbt->gain[fft_8k]);
	newmod->insertProperty("gain[4k]", &pdvbt->gain[fft_4k]);
	return newmod;
}
...
{
	qisprops_modconfig* newmod = new qisprops_modconfig();
	newmod->insertProperty("gain[qam16]", &pj83a->gain[j83a_qam16]);
	newmod->insertProperty("gain[qam32]", &pj83a->gain[j83a_qam32]);
	newmod->insertProperty("gain[qam64]", &pj83a->gain[j83a_qam64]);
	newmod->insertProperty("gain[qam128]", &pj83a->gain[j83a_qam128]);
	newmod->insertProperty("gain[qam256]", &pj83a->gain[j83a_qam256]);
	return newmod;
}
...
{
	qisprops_modconfig* newmod = new qisprops_modconfig();
	newmod->insertProperty("dc_offect", &patsc->dc_offect);
	newmod->insertProperty("gain", &patsc->dac_gain);
	return newmod;
}
...
{
	qisprops_modconfig* newmod = new qisprops_modconfig();
	newmod->insertProperty("gain[qam64]", &pj83b->gain_q64);
	newmod->insertProperty("gain[qam256]", &pj83b->gain_q256);
	return newmod;
}
...
{
	qisprops_modconfig* newmod = new qisprops_modconfig();
	newmod->insertProperty("pn_mag[c=3780]", &pdtmb->pn_mag[dtmb_carrier_3780]);
	newmod->insertProperty("pn_mag[c=1]", &pdtmb->pn_mag[dtmb_carrier_1]);
	newmod->insertProperty("ofdm_mag[c=3780][qpsk]", &pdtmb->ofdm_mag[dtmb_carrier_3780][dtmb_qpsk]);
	newmod->insertProperty("ofdm_mag[c=3780][qam16]", &pdtmb->ofdm_mag[dtmb_carrier_3780][dtmb_qam16]);
	newmod->insertProperty("ofdm_mag[c=3780][qam64]", &pdtmb->ofdm_mag[dtmb_carrier_3780][dtmb_qam64]);
	newmod->insertProperty("ofdm_mag[c=3780][qam4-nr]", &pdtmb->ofdm_mag[dtmb_carrier_3780][dtmb_qam4_nr]);
	newmod->insertProperty("ofdm_mag[c=3780][qam32]", &pdtmb->ofdm_mag[dtmb_carrier_3780][dtmb_qam32]);

	newmod->insertProperty("ofdm_mag[c=1][qpsk]", &pdtmb->ofdm_mag[dtmb_carrier_1][dtmb_qpsk]);
	newmod->insertProperty("ofdm_mag[c=1][qam16]", &pdtmb->ofdm_mag[dtmb_carrier_1][dtmb_qam16]);
	newmod->insertProperty("ofdm_mag[c=1][qam64]", &pdtmb->ofdm_mag[dtmb_carrier_1][dtmb_qam64]);
	newmod->insertProperty("ofdm_mag[c=1][qam4-nr]", &pdtmb->ofdm_mag[dtmb_carrier_1][dtmb_qam4_nr]);
	newmod->insertProperty("ofdm_mag[c=1][qam32]", &pdtmb->ofdm_mag[dtmb_carrier_1][dtmb_qam32]);

	newmod->insertProperty("tps_scale[qpsk]", &pdtmb->tps_scale[dtmb_qpsk]);
	newmod->insertProperty("tps_scale[qam16]", &pdtmb->tps_scale[dtmb_qam16]);
	newmod->insertProperty("tps_scale[qam64]", &pdtmb->tps_scale[dtmb_qam64]);
	newmod->insertProperty("tps_scale[qam4-nr]", &pdtmb->tps_scale[dtmb_qam4_nr]);
	newmod->insertProperty("tps_scale[qam32]", &pdtmb->tps_scale[dtmb_qam32]);

	newmod->insertProperty("fft_scale[qpsk]", &pdtmb->fft_scale[dtmb_qpsk]);
	newmod->insertProperty("fft_scale[qam16]", &pdtmb->fft_scale[dtmb_qam16]);
	newmod->insertProperty("fft_scale[qam64]", &pdtmb->fft_scale[dtmb_qam64]);
	newmod->insertProperty("fft_scale[qam4-nr]", &pdtmb->fft_scale[dtmb_qam4_nr]);
	newmod->insertProperty("fft_scale[qam32]", &pdtmb->fft_scale[dtmb_qam32]);

	newmod->insertProperty("gain[qpsk]", &pdtmb->tps_scale[dtmb_qpsk]);
	newmod->insertProperty("gain[qam16]", &pdtmb->tps_scale[dtmb_qam16]);
	newmod->insertProperty("gain[qam64]", &pdtmb->tps_scale[dtmb_qam64]);
	newmod->insertProperty("gain[qam4-nr]", &pdtmb->tps_scale[dtmb_qam4_nr]);
	newmod->insertProperty("gain[qam32]", &pdtmb->tps_scale[dtmb_qam32]);
...
{
	qisprops_modconfig* newmod = new qisprops_modconfig();
	newmod->insertProperty("scl_0", &pisdbt->scl_0);
	newmod->insertProperty("scl_1", &pisdbt->scl_1);
	newmod->insertProperty("scl_2", &pisdbt->scl_2);
	newmod->insertProperty("fft_scale[2k]", &pisdbt->fft_scale[fft_2k]);
	newmod->insertProperty("fft_scale[8k]", &pisdbt->fft_scale[fft_8k]);
	newmod->insertProperty("fft_scale[4k]", &pisdbt->fft_scale[fft_4k]);
	newmod->insertProperty("gain[2k]", &pisdbt->gain[fft_2k]);
	newmod->insertProperty("gain[8k]", &pisdbt->gain[fft_8k]);
	newmod->insertProperty("gain[4k]", &pisdbt->gain[fft_4k]);
	return newmod;
}
...
{
	qisprops_modconfig* newmod = new qisprops_modconfig();
	newmod->insertProperty("fftscale[1k]", &pdvbt2->fftscale[t2_fft_1k]);
	newmod->insertProperty("fftscale[2k]", &pdvbt2->fftscale[t2_fft_2k]);
	newmod->insertProperty("fftscale[4k]", &pdvbt2->fftscale[t2_fft_4k]);
	newmod->insertProperty("fftscale[8k]", &pdvbt2->fftscale[t2_fft_8k]);
	newmod->insertProperty("fftscale[16k]", &pdvbt2->fftscale[t2_fft_16k]);

	newmod->insertProperty("gain[1k]", &pdvbt2->gain[t2_fft_1k]);
	newmod->insertProperty("gain[2k]", &pdvbt2->gain[t2_fft_2k]);
	newmod->insertProperty("gain[4k]", &pdvbt2->gain[t2_fft_4k]);
	newmod->insertProperty("gain[8k]", &pdvbt2->gain[t2_fft_8k]);
	newmod->insertProperty("gain[16k]", &pdvbt2->gain[t2_fft_16k]);
	return newmod;
}
...
{
	{"B2 and B2+",qisprop_chiparch,(const Pqisprop_entry)&modcfg_entries[0],CONFIG_CHIPIDX_B2,},
