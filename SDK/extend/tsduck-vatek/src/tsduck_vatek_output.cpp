	...
	m_slicebuf(NULL)
{
	...
	help(u"frequency",
		...
		u"carrier. the valid range is 50000 KHz to 1000000 KHz."
		u"The default is 473000 KHz.");
...
vatek_result tsduck_vatek_output::configParam()
{
	...
	if (is_vatek_success(nres))
	{
		m_param.freq_khz = intValue(u"frequency", m_param.freq_khz);
